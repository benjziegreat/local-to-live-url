...
@Component({
  selector: 'app-tunnel-admin',
  standalone: true,
  imports: [FormsModule, NgClass],
  templateUrl: './tunnel-admin.component.html',
  styleUrl: './tunnel-admin.component.css',
})
export class TunnelAdminComponent implements OnInit {
